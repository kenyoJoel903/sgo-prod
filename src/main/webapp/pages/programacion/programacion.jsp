					...
					<div class="col-xs-12">
						<table class="sgo-simple-table table table-condensed">
			                <thead>
			                  <tr>
			                    <td class="celda-detalle" style="width:10%;"><label>Cliente/Operaci&oacute;n: </label></td>
			        			<td class="celda-detalle" style="width:26%;"><span id='detalleClienteOpe'>	</span></td>
			                    <td></td>
			                    <td class="celda-detalle" style="width:10%;"><label>Planta Despacho: </label></td>
			        			<td class="celda-detalle" style="width:20%;"><span id='detallePlanta'>	</span></td>
			                    <td></td>
			                    <td class="celda-detalle" style="width:10%;"><label>F. Planificada: </label></td>
			                    <td class="celda-detalle" style="width:7%;"><FONT COLOR=blue><B>	<span id='detalleFechaDescarga'>	</span></B></FONT></td>
			        			<td></td>
			        			<td class="celda-detalle" style="width:10%;"><label>F. Carga: </label></td>
				                <td class="celda-detalle" style="width:7%;"><FONT COLOR=blue><B>	<span id='detalleFechaCarga'>		</span></B></FONT> </td>
			                </tr>
			                </thead>
			              </table>
					</div>
					...
					<form id="frmPrincipal" class="form form-horizontal" role="form form-horizontal" novalidate="novalidate">
						<table class="sgo-simple-table table table-condensed">
			      			<thead>
			      				<tr>
			      				<td class="celda-detalle" style="width:10%;"><label>Cliente/Operaci&oacute;n:</label></td>
			      				<td class="celda-detalle" style="width:26%;" ><span id="cmpFormularioClienteOperacion" class="espaciado input-sm text-uppercase"> 	</span></td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label>Planta Despacho:</label></td>
			      				<td class="celda-detalle" style="width:20%;"><span id="cmpFormularioPlantaDespacho" class="espaciado input-sm text-uppercase">		</span></td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label>F. Planificada:</label> </td>
			      				<td class="celda-detalle"  style="width:7%;"><B><span class="form-control alert-danger text-center espaciado input-sm" id='cmpFormularioFechaDescarga'>	</span></B></td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label>F. Carga:</label> </td>
			      				<td class="celda-detalle"  style="width:7%;"><B><span class="form-control alert-danger text-center espaciado input-sm" id='cmpFormularioFechaCarga'>	</span></B></td>
			      				</tr>
								...
								<td class="celda-detalle" colspan="3">
			      				...
			      				<td class="celda-detalle" colspan="4">
			      					<table>
			      						<tr>
			      							<td><label class="etiqueta-titulo-horizontal">Cisternas Planificados:&nbsp;</label></td>
			      							<td><input id="cmpCisternasPlanificadas" name="cmpCisternasPlanificadas" type="text" class="form-control input-sm text-right"></td>
			      							<td colspan="1">&nbsp;&nbsp;&nbsp;</td>
			      							<td><label class="etiqueta-titulo-horizontal"> Cisternas Programados:&nbsp;</label></td>
								...
								<td class="celda-detalle" colspan="6">
			      					<table>
			      						<tr>
			      							<td><label class="etiqueta-titulo-horizontal">Vol. Planificados:&nbsp;</label></td>
			      							<td><input id="cmpVolumenPlanificado" name="cmpVolumenPlanificado" type="text" class="form-control input-sm text-right"></td>
			      							<td colspan="1">&nbsp;&nbsp;&nbsp;</td>
			      							<td><label class="etiqueta-titulo-horizontal"> Vol. Programados:&nbsp;</label></td>
				...
				<div class="box-header">
					<form id="frmCompletar" class="form form-horizontal" role="form form-horizontal" novalidate="novalidate">
						<table class="sgo-simple-table table table-condensed">
			      			<thead>
			      				<tr>
			      				<td class="celda-detalle" style="width:5%;"><label class="etiqueta-titulo-horizontal">Cliente / Operación: </label></td>
			      				<td class="celda-detalle" ><span id="cmpCompletarClienteOperacion" class="espaciado input-sm text-uppercase" readonly></span> </td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label class="etiqueta-titulo-horizontal">Planta Despacho: </label></td>
			      				<td class="celda-detalle" ><span id="cmpCompletarPlantaDespacho" class="espaciado input-sm text-uppercase" readonly /></td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label class="etiqueta-titulo-horizontal">F. Planificada: </label> </td>
			      				<td class="celda-detalle"  style="width:15%;"><span id="cmpCompletarFechaDescarga" type="text" class="form-control alert-danger text-center espaciado input-sm text-uppercase" readonly /></td>
			      				<td></td>
			      				<td class="celda-detalle" style="width:10%;"><label class="etiqueta-titulo-horizontal">F. Carga: </label> </td>
			      				<td class="celda-detalle"  style="width:15%;"><span id="cmpCompletarFechaCarga" type="text" class="form-control alert-danger text-center espaciado input-sm text-uppercase" readonly /></td>
			      				</tr>
			      				<tr> 
			      				<td class="celda-detalle" style="width:10%;"><label class="etiqueta-titulo-horizontal">Transportista: </label></td>
